...
#include "BluetoothUUIDInfo.h" //Be sure to create a new BluetoothUUIDInfo.h and then add each uuid to the header
...
scan_rsp.uuids128 = (ble_uuid128_t[]) {
    gatt_svr_svc_uuid
};
...
//make sure clients allow secure connections
    ble_hs_cfg.sm_sc = 1;
